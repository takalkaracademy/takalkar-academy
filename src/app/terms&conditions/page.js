...
export default function Home() {
  return (
    <div>
      <Navbar active={"terms&conditions"} />
      <div
      ...
      >
        <section class="container">
          ...
          <h4>I. Overview</h4>{" "}
          <p>
            This website, takalkarjeeneet.com and all subdomains of
            takalkarjeeneet.com, hereinafter referenced as site or website, are
            operated by Takalkar Education. Throughout the site, the terms “we”,
            “us” and “our” refer to Takalkar Education. Takalkar Education offers
          ...
          <p>
            ...
            browsers, vendors, customers, and/ or contributors of content.
          </p>{" "}
          <p>
          ...
          <h4>1. Website and Online Course Usage Terms</h4>{" "}
          <p>
          ...
          <p>
            Prices for our classroom courses, study material, online courses and
            other products and services are subject to change without notice.
          </p>{" "}
          <p>
          ...
          <h4>5. Products or Services</h4>{" "}
          <p>
            Certain products or services including our online courses and eBooks
            may be available exclusively online through the website or our
            partner websites. These products or services may have limited
            quantities and are subject to return or exchange only according to
            our{" "}
            <a href="#" data-scrollto="section-return">
              Return Policy
            </a>
            .
          </p>{" "}
          <p>
            ...
            pricing are subject to change at anytime without notice, at our sole
          ...
          <p>
            ...
            judgment, might meet certain criteria that we think might harm our
            business interests.{" "}
          </p>{" "}
          <p>
          ...
          <ol style={{listStyle: "inside"}}>
            ...
            <li>or (3) to respond to any comments.</li>{" "}
          </ol>{" "}
          <p>
          ...
          <p>
            ...
            governed by our <a href="privacy-policy.shtml">Privacy Policy</a>.
          </p>{" "}
          ...
          <p>
            In no case shall Takalkar Education, its proprietor, directors,
          ...
          <p>
            You agree to indemnify, defend and hold harmless Takalkar Education
          ...
          <p>
            ...
            accordance with the laws of India and jurisdiction of Chennai,
            Tamilnadu.
          </p>{" "}
          ...
          <p>
            ...
            takalkarjeeneetacademy09@gmail.com
          </p>{" "}
        </section>
      </div>
      {/* <Footer /> */}
